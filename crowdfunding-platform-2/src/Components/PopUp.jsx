...
const PopUp = ({setOpenModel, donate, donateFunction, getDonate}) => {
  ...
  useEffect(() => {
    const donationsListData = getDonate(donate.pId);
    return async () => {
  ...
  return (
    <>
      <div className="justify-center items-center flex overflew-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:ontline-none">
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="relative p-6 flex-auto">
              ...
              <input
                ...
                required
                type="text"
                className="flex-grow w-full h-12 px-4 mb-2 transition duration-200 bg-white border bouder-gray-300 rounded shadow-sm
